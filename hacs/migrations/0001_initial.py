# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-19 17:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('whitelisted_uri', models.CharField(blank=True, help_text=b'regex formatted uri those will be treated as whitelisted and request will be discarded by firewall if uri not match', max_length=255, null=True, verbose_name='whitelisted uri')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('handlers', hacs.fields.DictField(blank=True, default=b'', null=True, validators=[hacs.validators.HttpHandlerValidator()], verbose_name='Handlers')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route', models.ForeignKey(db_column=b'route_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='hacs_route_sites', to='hacs.RoutingTable')),
        ...
        migrations.AddField(
            model_name='contenttyperoutingrules',
            name='route',
            field=models.ForeignKey(db_column=b'route_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='hacs_route_contenttypes', to='hacs.RoutingTable'),
        ),
        migrations.AddField(
            model_name='contenttyperoutingrules',
            name='site',
