"""""
1. Completely copied from https://github.com/carljm/django-model-utils/blob/master/model_utils/tracker.py
2. For copyright info: https://github.com/carljm/django-model-utils/blob/master/LICENSE.txt
3. Modified by Md Nazrul Islam <connect2nazrul@gmail.com> to fit for HACS
"""""
...
class FieldTracker(object):
    ...
    def contribute_to_class(self, cls, name):
        ...
        if cls._meta.abstract and self.name == "hacs_tracker":
            self.finalize_class(cls)
        else:
